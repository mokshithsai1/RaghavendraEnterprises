import {jsxs as _jsxs, jsx as _jsx} from "react/jsx-runtime";"use client"
...
(({ className, children, ...props }, ref) => (
 ...
 children: [
    children
    , _jsx(SelectPrimitive.Icon, { asChild: true, children: 
...
(({ className, children, position = "popper", ...props }, ref) => (
  _jsx(SelectPrimitive.Portal, { children: 
...
(({ className, children, ...props }, ref) => (
  _jsxs(SelectPrimitive.Item, {
    ...
    ...props,
 children: [
    _jsx('span', { className: "absolute right-2 flex h-3.5 w-3.5 items-center justify-center"      , children: 
      _jsx(SelectPrimitive.ItemIndicator, { children: 
