...
function SidebarProvider({
  ...
  return (
    _jsx(SidebarContext.Provider, { value: contextValue, children: 
      _jsx(TooltipProvider, { delayDuration: 0, children: 
        _jsx('div', {
...
function Sidebar({
 ...
 children: 
  ...
  if (isMobile) {
    return (
      _jsx(Sheet, { open: openMobile, onOpenChange: setOpenMobile, ...props, children: 
        _jsxs(SheetContent, {
          ...
          side: side,
 children: [
          _jsxs(SheetHeader, { className: "sr-only", children: [
